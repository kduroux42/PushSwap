...
LIBFT_DIR = ./srcs/libft/srcs/libft/
SOURCES_LIBFT = \
...
GNL_DIR = ./srcs/libft/srcs/gnl/
SOURCES_GNL = \
	get_next_line.c

PRINTF_DIR  = ./srcs/libft/srcs/printf/
SOURCES_PRINTF = \
...
OBJECTS = $(OBJECTS_LIBFT) $(OBJECTS_GNL) $(OBJECTS_PRINTF) $(OBJECTS_PUSH_SWAP)
CC = cc
